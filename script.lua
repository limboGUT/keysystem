...
local Config = {
    ...
    ServiceId       = 24423, -- Your PlatoBoost Service ID
    PlatoSecret     = "11b60ef4-0a91-4b2f-9a5c-6487ee4879f1", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/limboGUT/keysystem/refs/heads/main/kiddie.lua", -- The raw URL of your main script
    ...
    -- [5] File System
    KeyFileName     = "OBJkey.txt", -- The name of the file where the valid key will be saved for auto-login
    ...
    HubName         = "OBL Hub", -- The main title shown at the top of the GUI
    HubDescription  = "Please Complete the Required Task to Acess this Script." -- The text shown below the title
}
